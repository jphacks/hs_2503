...
const translations = {
  ja: {
    ...
    "help-title": "「もう迷わせない、\nあなたの避難を」",
    "help-description": "hinaviは、災害時に必要な情報をわかりやすく提供する避難支援アプリです。",
    "disasters-and-evacuation-centers-title": "最新の災害・避難所情報を\nすぐに確認",
    "disasters-and-evacuation-centers-description": "現在地周辺の災害状況や避難所情報をすぐに確認できます。",
    "evacuation-route-title": "近くの避難所までの\n最短ルートを案内",
    "evacuation-route-description": "GPSを活用し、現在地から避難所までのルートを表示・案内します。",
    "comment-title": "被災状況を共有し\n助け合いをサポート",
    "comment-description": "地図上で「通れない道」「段差」などの情報を投稿・確認できます。",
    "multilingual-support-title": "多言語対応で誰でも安心",
    "multilingual-support-description": "現在は、日本語・英語・中国語に対応しています。",
    "pre-btn": "戻る",
    "next-btn": "次へ",
